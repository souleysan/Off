...
Il s'agit d'un remasting du jeu de carte le "8 Americain". Avec un deck de 8 cartes par joueurs, l'objectif est de se débarraser de toutes ses cartes. C'est un jeu qui se joue au tour par tour, dans lequel (pour la 1e version) on autorisera un maximum de 4 joueurs.
...
- Implémenter une version console fonctionnelle et jouable
  - Permetra d'éxecuter plusiers parties complétes, avec un maximum de 4 joueurs
- Développer une version graphique (si Dieu le veut 😅)
  - Bibliothèque AWT/Swing/JavaFX
